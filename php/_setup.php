...
function createAllTables()
{
		...
		SQL_query("CREATE TABLE `selectbf_cache_chartypeusage` (  `kit` varchar(191) NOT NULL default '',  `percentage` float default NULL,  `times_used` int(10) signed default NULL,  PRIMARY KEY  (`kit`)) ENGINE=MyISAM;");
...
$tmpl = new clausvb\vlib\vlibTemplate("templates/original/_setup.html");
